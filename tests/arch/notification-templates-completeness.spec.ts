/** Матрица переиспользует единственный источник `notification-event-matrix.ts`, НЕ импортирована из сида (иначе ошибка автора шаблонов осталась бы незамеченной). */
