 ...
 * `0037_returns_disputes_support.sql`, DDL 1:1 `11-database-schema.md` строки 134-137.
 ...
 * `0037_returns_disputes_support.sql`, `11-database-schema.md` строки 138-140. `undelivered` —
 ...
 * `0037_returns_disputes_support.sql`, `11-database-schema.md` строка 142.
 * Порядок значений НЕ переименовывать, только дописывать в конец.
 */
 ...
 * `0037_returns_disputes_support.sql`, `11-database-schema.md` строки 145-148. Таблица
