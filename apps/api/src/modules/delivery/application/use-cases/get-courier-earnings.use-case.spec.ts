/**
 * Unit-тест `GetCourierEarningsUseCase` (EP-13, DTJ-321, тест-план тикета) — RBAC-разграничение
 * `own` (courier) vs обязательный фильтр (`super_admin`), делегация курсорной пагинации.
 */
