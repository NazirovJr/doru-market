...
@Module({
  ...
  // auth.module.ts), тот же приём, что CartIdentityGuard/orders.module.ts. DTJ-381 переиспользует
  // тот же импорт для AuthGuard/RolesGuard AnalyticsDashboardController.
  imports: [AuthModule],
