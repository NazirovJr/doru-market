...
import type { IngestInventoryBatchCommand } from '../../application/use-cases/ingest-inventory-batch-with-matching.use-case.js'
import type { IngestRowInput } from '../../application/use-cases/ingest-inventory-batch-with-matching.use-case.js'

export class RestInventoryRequestToCommandMapper {
  static toCommand(
    ...
    return {
      ...
      isLastPage: dto.is_last_page ?? true,
      rows,
    }
  }
}
