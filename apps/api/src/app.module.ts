 ...
 */
@Module({
  imports: [AppConfigModule, LoggerModule, HealthModule, DatabaseModule, RedisModule, SharedKernelModule, OpenApiModule, IdempotencyModule, AuditLogModule, DomainEventsModule, TenancyModule, OnboardingModule, CatalogModule, InventoryModule, AuthModule, OrdersModule, PaymentsModule, ReturnsModule, SupportModule, AdminModule, NotificationsModule, AnalyticsModule, DeliveryModule, ScheduleModule.forRoot()],
  providers: [
