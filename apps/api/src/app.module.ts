 ...
 */
@Module({
  imports: [AppConfigModule, LoggerModule, HealthModule, DatabaseModule, RedisModule, SharedKernelModule, OpenApiModule, IdempotencyModule, AuditLogModule, TenancyModule, OnboardingModule, CatalogModule, InventoryModule, AuthModule, OrdersModule, PaymentsModule, ReturnsModule, SupportModule, AdminModule, NotificationsModule, AnalyticsModule, ScheduleModule.forRoot()],
  providers: [
