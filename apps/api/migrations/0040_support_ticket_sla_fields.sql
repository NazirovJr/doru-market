-- =====================================================================================
-- 0040_support_ticket_sla_fields.sql — EP-14 (DTJ-278), SLA первого ответа + приоритет
-- support_tickets, append-only переписка по тикету. Волна 8, депендс на DTJ-270 (0039).
-- =====================================================================================
-- Номер сверен НЕПОСРЕДСТВЕННО перед созданием файла: `ls apps/api/migrations/` — последняя
-- запись на диске `0039_returns_disputes_support.sql` (эта же волна, DTJ-270), следующий
