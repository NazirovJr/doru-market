...
const SUPER_ADMIN_PATHS = ['tenants', 'feature-flags', 'audit-log', 'undelivered-notifications', 'analytics/funnel', 'pharmacies', 'users', 'orders', 'finance', 'settings']
const PHARMACY_ADMIN_PATHS = ['my-pharmacies', 'my-orders', 'staff', 'integration-keys', 'reports', 'schedule']

describe('getRoutesForRole', () => {
  it('super_admin получает все 10 разделов админ-панели', () => {
