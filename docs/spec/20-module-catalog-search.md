...
| **TC-CAT-013** | SRS-CAT-036, расчёт экономии | Референсный товар `83.00 TJS`, самый дешёвый аналог в радиусе `18.00 TJS` | `GET /medicines/:id/analogs` | `savingsDiram = 6500` (не округлено), баннер показывает `«Сэкономьте 65.00 сомони»` |
